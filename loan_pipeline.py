    ...
    with st.container():
        ...
        with col2:
            ...
            with c2:
                ...
                if len(error_applications_count_list) > 0:
                    st.button(label = "Priortize", key = "accuracy", help = "Please be Watchful while Processing!")
                ...
                if len(effectivity_applications_count_list) > 0:
                    st.button(label = "Priortize", key = "effectivity", help = "Click here to Priortize Applications")

    ...
    with st.container():
        ...
        with col2:
                ...
                if len(productivity_applications_count_list) > 0 or len(efficiency_applications_count_list) > 0 or len(error_applications_count_list) > 0: 
                    if len(productivity_applications_count_list) > 0:
                        if len(productivity_applications_count_list) == 1:
                            # <i class="fa fa-filter" style="font-size:24px;color:blue"></i>
                    ...
                    if len(error_applications_count_list) > 0:
                        if len(most_frequent_error_type_list) == 1 and len(error_applications_count_list) == 1:
                            st.markdown("<h style = 'font-size: 15px;'><span style = 'color: DodgerBlue; font-size: 17px'>**Accuracy:**</span>: High Likelihood of below error in **{}** Application: <br> &emsp;&emsp;&emsp;&emsp;&ensp; <span style = 'color: Red'> **{}**</span></h>".format(len(error_applications_count_list), error_type_string), unsafe_allow_html = True)
                            ...
                            st.markdown("<h style = 'font-size: 15px;'><span style = 'color: DodgerBlue; font-size: 17px'>**Accuracy:** High Likelihood of below errors in **{}** Applications: <br> &emsp;&emsp;&emsp;&emsp;&ensp; <span style = 'color: Red'> **{}**</span></h>".format(len(error_applications_count_list), error_type_string), unsafe_allow_html = True)
                        else:
                            st.markdown("<h style = 'font-size: 15px;'><span style = 'color: DodgerBlue; font-size: 17px'>**Accuracy:**</span> High Likelihood of below errors in **{}** Applications: <br> &emsp;&emsp;&emsp;&emsp;&ensp; <span style = 'color: Red'> **{}**</span></h>".format(len(error_applications_count_list), error_type_string), unsafe_allow_html = True)
                    ...
                    #         # <i class="fa-solid fa-filter"></i>
                    #         # <i style="font-size:24px" class="fa">&#xf0b0;</i>
                    #         productivity_msg = st.markdown("""<h style = 'font-size: 13px;'>Productivity: **{}** Application in your pipeline is anticipated to complete in total **{}** minutes. &ensp;<a id = 'productivity'>Click here to Priortize</a></h>""".format(len(productivity_applications_count_list), productivity_total_time_to_complete), unsafe_allow_html = True)
                    #     else:
                    #         productivity_msg = st.markdown("""<h style = 'font-size: 13px;'>Productivity: **{}** Applications in your pipeline are anticipated to complete in total **{}** minutes. &ensp;<a id = 'productivity'>Click here to Priortize</a></h>""".format(len(productivity_applications_count_list), productivity_total_time_to_complete), unsafe_allow_html = True)
                    
                    # if len(efficiency_applications_count_list) > 0:
                    #     if len(efficiency_applications_count_list) == 1:
                    #         efficiency_msg = st.markdown("""<h style = 'font-size: 13px;'>Efficiency: **{}** Application with an average closure time of **{}** minutes. &ensp;<a href = '#' id = 'efficiency'>Click here to Priortize</a></h>""".format(len(efficiency_applications_count_list), efficiency_average_time_to_complete), unsafe_allow_html = True)
                    #     else:
                    #         efficiency_msg = st.markdown("""<h style = 'font-size: 13px;'>Efficiency: **{}** Applications (each) with an average closure time of **{}** minutes. &ensp;<a href = '#' id = 'efficiency'>Click here to Priortize</a></h>""".format(len(efficiency_applications_count_list), efficiency_average_time_to_complete), unsafe_allow_html = True)
                    ...
                    #         st.markdown("""<h style = 'font-size: 13px;'>Accuracy: High Likelihood of below error in **{}** Application: &ensp;<a id = 'accuracy'>Click here to Priortize</a> <br> **{}**</h>""".format(len(error_applications_count_list), error_type_string), unsafe_allow_html = True)
                    #     elif len(most_frequent_error_type_list) > 1 and len(most_frequent_error_type_list) <= 3:
                    #         st.markdown("""<h style = 'font-size: 13px;'>Accuracy: High Likelihood of below errors in **{}** Applications: &ensp;<a id = 'accuracy'>Click here to Priortize</a> <br> **{}**</h>""".format(len(error_applications_count_list), error_type_string), unsafe_allow_html = True)
                    #     else:
                    #         st.markdown("""<h style = 'font-size: 13px;'>Accuracy: High Likelihood of below errors in **{}** Applications: &ensp;<a id = 'accuracy'>Click here to Priortize</a> <br> **{}**</h>""".format(len(error_applications_count_list), error_type_string), unsafe_allow_html = True)
                    
                    # if len(effectiveness_applications_count_list) > 0:
                    #     if len(effectiveness_applications_count_list) == 1:
                    #         st.markdown("""<h style = 'font-size: 13px;'>Effectiveness: **{}** Application has high possibility of SLA breach. &ensp;<a id = 'effectiveness'>Click here to Priortize</a></h>""".format(len(effectiveness_applications_count_list)), unsafe_allow_html = True)
                    #     else:
                    #         st.markdown("""<h style = 'font-size: 13px;'>Effectiveness: **{}** Applications have high possibility of SLA breach. &ensp;<a id = 'effectiveness'>Click here to Priortize</a></h>""".format(len(effectiveness_applications_count_list)), unsafe_allow_html = True)             
                else:
                    ...
                    # st.write(effectiveness_applications_count_list)
            ...
            with c2:
                ...
                # st.write('')
                if len(productivity_applications_count_list) > 0:
                    productivity_btn = st.button(label = "Priortize", key = "productivity", help = "Click here to Priortize Applications")
                
                if len(efficiency_applications_count_list) > 0:
                    efficiency_btn = st.button(label = "Priortize", key = "efficiency", help = "Click here to Priortize Applications")
                
                if len(error_applications_count_list) > 0:
                    # st.markdown("<style> {'background-color: red' !important}</style>", unsafe_allow_html=True)
                    st.button(label = "Priortize", key = "accuracy", help = "Please be Watchful!")
                    # ("<style>.metric-label, .metric-value { font-size: 5px !important; }</style>", unsafe_allow_html = True)

                if len(effectiveness_applications_count_list) > 0:
                    st.button(label = "Priortize", key = "effectiveness", help = "Click here to Priortize Applications")
                    # st.markdown("<stbutton style = 'background-color: red'></button>", unsafe_allow_html=True)
